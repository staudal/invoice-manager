              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {invoices.map((invoice) => (
                  <tr key={invoice.id}>
                    ...
                    <td className="hidden sm:table-cell whitespace-nowrap px-3 py-4 text-sm text-gray-500">{capitalizeFirstLetter(invoice.client_name)}</td>
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{getTotal(invoice.id).toLocaleString("en-DK")} kr.</td>
                    <td className="hidden sm:table-cell whitespace-nowrap px-3 py-4 text-sm text-gray-500">{capitalizeFirstLetter(invoice.status)}</td>
